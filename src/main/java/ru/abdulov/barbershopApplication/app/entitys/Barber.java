...
public class Barber {
    ...
    @OneToMany(cascade = CascadeType.ALL, fetch = FetchType.LAZY, mappedBy = "barber")  //Если images относится к barber как manyToOne, то barber относится к ним oneToMany
